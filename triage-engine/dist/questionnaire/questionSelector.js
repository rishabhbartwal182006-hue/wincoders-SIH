 ...
 */
export function isQuestionAnswered(question, session) {
...
export function getNextQuestion(sessionId) {
    ...
    const questionBattery = routeSymptomToQuestionSet(primarySymptom.symptomName, primarySymptom.site);
...
export function shouldInterruptQuestionnaire(sessionId) {
    const session = getSession(sessionId);
