...
> [!NOTE]
> **Zero Global NPM Installs Required**: All utilities (`tsx`, `typescript`, `zod`, `socket.io`, `express`, `cors`) are declared locally inside `package.json`.
...
3. **How do I verify clinical safety and thresholds?**:
   - All clinical thresholds are documented as illustrative demonstration models for hackathon evaluation. See [DISCLAIMER.md](DISCLAIMER.md) for full clinical safety notice.
